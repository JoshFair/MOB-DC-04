...
func knockMultipleTimes(x: Int) {
    for i in 1...x { RespondToKnockKnockInquiry() }
}
...
func replyWhoIsHere(strName: String, strHomeCountry: String) {
    print("It's me, \(strName) , from \(strHomeCountry)")
}
